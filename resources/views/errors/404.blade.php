...
@section('htmlheader_title')
    {{ trans('ams::message.pagenotfound') }}
@endsection

@section('contentheader_title')
    {{ trans('ams::message.404error') }}
@endsection
...
<div class="error-page">
    ...
    <div class="error-content">
        <h3><i class="fa fa-warning text-yellow"></i> Oops! {{ trans('ams::message.pagenotfound') }}.</h3>
        <p>
            {{ trans('ams::message.notfindpage') }}
